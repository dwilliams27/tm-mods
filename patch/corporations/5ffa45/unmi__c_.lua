...
buttonSetup.actions[1].actionProperties={resourceValues={Credits=-3},effects={"TR"}}
buttonSetup.actions[1].height=250
buttonSetup.actions[1].width=450
cardUxLibrary.addOffset(buttonSetup.actions[1],{0.4,0,0.75})