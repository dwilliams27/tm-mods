...
initSimpleActionButtons(2)
buttonSetup.counters[1]=buttonSetup.defaultCorpCounter
buttonSetup.actions[1].actionProperties={productionValues={Credits=1},isRepeatable=true}
buttonSetup.actions[1].onActivated=function(playerColor) changeCounterEffect(1,1)() end
buttonSetup.actions[2].actionProperties={resourceValues={Credits=3},isRepeatable=true}
buttonSetup.actions[1].width=400
buttonSetup.actions[1].height=250
buttonSetup.actions[2].width=400
buttonSetup.actions[2].height=250
buttonSetup.counters[1].height=400
buttonSetup.counters[1].width=350
cardUxLibrary.addOffset(buttonSetup.counters[1],{-0.35,0,0.45})
cardUxLibrary.addOffset(buttonSetup.actions[1],{0.35,0,0.1})
cardUxLibrary.addOffset(buttonSetup.actions[2],{0.35,0,0.3})
function onPlayerTurnBegan(params)
local activationEffects={resourceValues={},productionValues={},effects={"City"}}
...
setupEventHandler(eventData.triggerType.marsCityPlayed,eventData.triggerScope.anyPlayer,1)
setupEventHandler(eventData.triggerType.marsCityPlayed,eventData.triggerScope.playerThemself,2)
setupEventHandler(eventData.triggerType.spaceCityPlayed,eventData.triggerScope.playerThemself,2)
setupEventHandler(eventData.triggerType.playerTurnBegan,eventData.triggerScope.playerThemself,-1,{callbackName="onPlayerTurnBegan"})