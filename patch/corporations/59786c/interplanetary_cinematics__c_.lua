...
buttonSetup.counters[1]=buttonSetup.defaultCounter
buttonSetup.counters[1].width=400
buttonSetup.counters[1].height=400
buttonSetup.actions[1].height=250
buttonSetup.actions[1].width=400
buttonSetup.actions[1].actionProperties={resourceValues={Credits=2},isRepeatable=true}
buttonSetup.actions[1].onActivated=function(playerColor) changeCounterEffect(1,1)() end
cardUxLibrary.addOffset(buttonSetup.actions[1],{0.55,0,0.92})
cardUxLibrary.addOffset(buttonSetup.counters[1],{-0.45,0,0.18})
setupEventHandler(eventData.triggerType.eventTagPlayed,eventData.triggerScope.playerThemself,1)