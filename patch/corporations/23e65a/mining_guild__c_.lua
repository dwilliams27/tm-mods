...
buttonSetup.actions[1].actionProperties={productionValues={Steel=1},isRepeatable=true}
buttonSetup.actions[1].onActivated=function() changeCounter(1,1) end
buttonSetup.counters[1]=buttonSetup.defaultCorpCounter
buttonSetup.actions[1].height=250
buttonSetup.actions[1].width=350
buttonSetup.counters[1].height=400
buttonSetup.counters[1].width=450
cardUxLibrary.addOffset(buttonSetup.counters[1],{-0.3,0,0.0})
cardUxLibrary.addOffset(buttonSetup.actions[1],{0.55,0,0.65})
function onTilePlaced(params)
local placementProperties=params.metadata.placementProperties
local adjacenyPlacementProperties=params.metadata.adjacenyPlacementProperties
if placementProperties.resourceValues.Steel~=nil and placementProperties.resourceValues.Steel > 0 then
actionCheckSimple(1,params.playerColor,false)
return
elseif placementProperties.resourceValues.Titanium~=nil and placementProperties.resourceValues.Titanium > 0 then
actionCheckSimple(1,params.playerColor,false)
return
end
for _,properties in pairs(adjacenyPlacementProperties) do
if properties.resourceValues~=nil then
if properties.resourceValues.Steel~=nil and properties.resourceValues.Steel > 0 then
actionCheckSimple(1,params.playerColor,false)
return
elseif properties.resourceValues.Titanium~=nil and properties.resourceValues.Titanium > 0 then
actionCheckSimple(1,params.playerColor,false)
return
end
end
...
setupEventHandler(eventData.triggerType.marsTilePlaced,eventData.triggerScope.playerThemself,-1,{callbackName="onTilePlaced"})