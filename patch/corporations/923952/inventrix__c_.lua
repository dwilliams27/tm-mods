...
cardProperties={requirementMods={Temp=2,Ocean=2,O2=2,TFVenus=2}}
buttonSetup.cardMode=nil
function onPlayerTurnBegan(params)
local activationEffects={resourceValues={},productionValues={},effects={"DrawCard","DrawCard","DrawCard"}}
